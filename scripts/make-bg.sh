...
# off, 2400px on the long side. The stage loads public/bg/<slug>.webp (q80),
# then public/bg/<slug>.jpg (q88), then public/prints/<slug>.jpg.
...
for f in public/masters/jpg/*.jpg; do
  ...
  magick "public/bg/$s.jpg" -quality 80 "public/bg/$s.webp"
  echo "public/bg/$s.jpg, .webp"
done
